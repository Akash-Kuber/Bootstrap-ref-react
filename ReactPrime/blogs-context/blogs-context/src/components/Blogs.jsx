...
const Blogs = () => {
  ...
  // Step 3 (Consume)
  // Here we are using useContext for fetching variable | AppContext is context which we are created in AppContextFile, the reason for putting this in bkt is Context will be multiple
